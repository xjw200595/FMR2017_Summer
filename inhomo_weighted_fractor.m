...
end_freq = 21;
step_freq = 0.2;
Solution = zeros(10001,(end_freq - start_freq)./step_freq+1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%       Swipe frequency
sigma = 0.3;
...
for i = 1:13
    ...
    temp = FindIntensity(parameters, beta1, beta2, start_freq,end_freq,step_freq);
...
function Solution = FindIntensity(parameters, beta1, beta2, first, last, step)
Solution = [];
alpha1 = parameters(1);
alpha2 = parameters(2);
gamma1 = parameters(3);
